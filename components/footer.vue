<template>
  <div class="">
    <div class="bg-tertiary text-white">
      <div class="container lg:max-w-5xl py-5 px-4 mx-auto">
        ...
        <div class="flex flex-wrap justify-between items-start">
          ...
          <div class="py-2 w-full sm:w-2/4 lg:w-1/3">
            <nuxt-link to="/" class="mb-4">
              <!-- Sho_oebai -->
              <Logo></Logo>
            </nuxt-link>
            <p class="">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Voluptatibus veniam nemo natus libero vero dolor incidunt
              doloribus repellat quidem. Repellat eligendi rerum itaque
              perspiciatis? Consectetur omnis nostrum sit libero. Dolor.
            </p>
            <p class="tel">
              <span>call us on </span>
              <!-- <a href="tel:+" class="bg-tertiary text-white color-dark">45765458</a> -->
              <a href="tel:+234100566890" class="text-sm">+234100566890</a>
            </p>
            <p class="mail">
              <span>send a mail to: </span>
              <!-- <a href="mailto:" class="bg-tertiary text-white color-dark">axfjhhk</a> -->
              <a href="mailto: support@shooebai.com" class="text-sm"
                >support@shooebai.com</a
              >
            </p>
          </div>
    ...
    <!-- <div class="bg-white color-primary">
      <div class="container lg:max-w-5xl py-5 px-4 mx-auto font-semibold">
        <p class="w-full text-center color-primary">
          <span></span>
          <a href="https://veedahv.me" class="color-primary">Victoria Akpan</a>
        </p>
      </div>
    </div> -->
  </div>
